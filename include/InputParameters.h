...
typedef struct inputParameters {
   ...
   int rad;                     // 0: Born cross section, 1:unpol radiative cross section with vertex smearing, 2:unpol radiative cross section without vertex smearing
   ...
   int ThreshType;                     //0---kElastic; 1----kPion for radiation integration
   ...
   inputParameters(): 
      ...
      num_evt(0),tgt_Z(0),tgt_A(0),scale(0),rad(0),RL(0),RLb(0),RLa(0),ThreshType(0),Fit_model(0)
   {}
