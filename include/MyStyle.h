...
void UseMyFitStyle(bool bStatAt2ndLine=true);

void UseMyFitStyle(bool bStatAt2ndLine)
{
    TStyle *MyFitStyle=gStyle;
    MyFitStyle->SetPalette(1);

    MyFitStyle->SetPadLeftMargin(0.10);  
    //MyFitStyle->SetPadRightMargin(0.10); 
    MyFitStyle->SetPadBottomMargin(0.10); 

    //histo title
    MyFitStyle->SetTitleX(MyFitStyle->GetPadLeftMargin()+0.02);
    ...
    MyFitStyle->SetOptFit(011);
    MyFitStyle->SetStatX(0.99);
    if(bStatAt2ndLine) 
    {
        MyFitStyle->SetStatY(0.90);
        MyFitStyle->SetStatW(0.18);
    }
    else 
    {
    ...
    MyFitStyle->SetTextColor(1);	//set the default text color to blue 
    MyFitStyle->SetTextSize(0.06);	//don't know what it will do yet 


    //axis title
    MyFitStyle->SetTitleOffset(0.8,"X"); 
    MyFitStyle->SetTitleOffset(0.9,"Y"); 
    MyFitStyle->SetTitleSize(0.05,"X");
    MyFitStyle->SetTitleSize(0.05,"Y");
    ...
    MyFitStyle->SetLabelSize(0.04,"X");
    MyFitStyle->SetLabelSize(0.04,"Y");
